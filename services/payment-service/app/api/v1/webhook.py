...
async def stripe_webhook(
    ...
    if not stripe_signature:
        logger.warning("payment.stripe_webhook_missing_signature", extra={"event": "payment.stripe_webhook_invalid"})
    ...
    try:
        ...
        logger.warning("payment.stripe_webhook_invalid", extra={"event": "payment.stripe_webhook_invalid"})
